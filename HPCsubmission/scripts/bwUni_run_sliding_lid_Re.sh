...
echo "Initiating flow pattern comparison by varying omega to simulate different Reynolds number" 
...
echo "Initiating flow pattern comparison by varying velocity to simulate different Reynolds number" 
